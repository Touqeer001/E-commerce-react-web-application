...
router.put("/auth/password", c.changePassword);
router.get("/dashboard", c.dashboard);
router
  .route("/categories")
  .get(c.listCategories)
  .post(authorizeRoles("SUPER_ADMIN", "ADMIN"), c.createCategory);
router
  .route("/categories/:id")
  .put(authorizeRoles("SUPER_ADMIN", "ADMIN"), c.updateCategory)
  .delete(authorizeRoles("SUPER_ADMIN"), c.deleteCategory);
router
  .route("/products")
  .get(c.listProducts)
  .post(
...
router
  ...
  .delete(authorizeRoles("SUPER_ADMIN", "ADMIN"), c.deleteProduct);
router.patch(
  "/products/:id/stock",
  authorizeRoles("SUPER_ADMIN", "ADMIN", "EDITOR"),
  c.updateStock,
